  ...
  scoped(
    Effect.gen(function* () {
      ...
      expect(received).toEqual([
        { id: expect.any(String), method: "agent.state", params: { agent: "w1:p1", state: "working" } },
        { id: expect.any(String), method: "agent.state", params: { agent: "w1:p1", state: "blocked" } },
        { id: expect.any(String), method: "agent.state", params: { agent: "w1:p1", state: "idle" } },
      ]);
    }),
  ),
);
