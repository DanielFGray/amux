...
describe("scroll", () => {
  ...
  it("scroll wheel events reach the pane through nested boxes (App layout)", async () => {
    ...
    const outerRow = new BoxRenderable(t.renderer, {
      flexDirection: "row",
      flexGrow: 1,
    });
    ...
    const center = new BoxRenderable(t.renderer, {
      flexDirection: "column",
      flexGrow: 1,
    });
    const tabs = new BoxRenderable(t.renderer, {
      height: 1,
      backgroundColor: "#313244",
    });
    const paneArea = new BoxRenderable(t.renderer, {
      flexDirection: "row",
      flexGrow: 1,
    });
